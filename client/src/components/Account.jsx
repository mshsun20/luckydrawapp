...
import { FaUserPlus, FaUserEdit, FaUserMinus, FaCloudUploadAlt } from 'react-icons/fa'
        ...
        <div className='container'>
          <div className='account'>
            ...
            <div className="accdtl">
              ...
              <div className="accimp"><span>Bulk Accounts Upload : </span><NavLink to='/upldacc' className='navlnk'><button className='upldbtn'><FaCloudUploadAlt/></button></NavLink></div>
            </div>
